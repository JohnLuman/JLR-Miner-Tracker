...
assert.equal(pkg.version,'2.9.136','package version is the Adam wake-word release');
assert.ok(server.includes("version:'2.9.136'"),'server public version is 2.9.136');
assert.ok(index.includes('/app.js?v=2.9.136'),'browser cachebuster loads the Adam build');
