...
assert.equal(pkg.version,'2.9.139','owner feedback release is versioned');
assert.ok(index.includes('/app.js?v=2.9.139'),'browser loads the owner-feedback app build');
