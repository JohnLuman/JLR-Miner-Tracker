...
assert.equal(pkg.version,'2.9.135','owner feedback release is versioned');
assert.ok(index.includes('/app.js?v=2.9.135'),'browser loads the owner-feedback app build');
