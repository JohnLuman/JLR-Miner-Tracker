...
const GAS_REGIONS = {
  ...
  Wormhole:{
    ...
    sites:[
      {name:'Barren Perimeter Reservoir',gas:'Fullerite-C60',region:'Wormhole',security:'C1-C4 W-space',units:6000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Barren Perimeter Reservoir',gas:'Fullerite-C50',region:'Wormhole',security:'C1-C4 W-space',units:12000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Token Perimeter Reservoir',gas:'Fullerite-C70',region:'Wormhole',security:'C1-C4 W-space',units:6000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Token Perimeter Reservoir',gas:'Fullerite-C60',region:'Wormhole',security:'C1-C4 W-space',units:12000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Minor Perimeter Reservoir',gas:'Fullerite-C72',region:'Wormhole',security:'C1-C4 W-space',units:6000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Minor Perimeter Reservoir',gas:'Fullerite-C70',region:'Wormhole',security:'C1-C4 W-space',units:12000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Ordinary Perimeter Reservoir',gas:'Fullerite-C84',region:'Wormhole',security:'C1-C4 W-space',units:6000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Ordinary Perimeter Reservoir',gas:'Fullerite-C72',region:'Wormhole',security:'C1-C4 W-space',units:12000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Sizeable Perimeter Reservoir',gas:'Fullerite-C50',region:'Wormhole',security:'C1-C4 W-space',units:6000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Sizeable Perimeter Reservoir',gas:'Fullerite-C84',region:'Wormhole',security:'C1-C4 W-space',units:12000,clouds:2,guarded:true,hazard:'Sleepers after warp-in delay'},
      {name:'Bountiful Frontier Reservoir',gas:'Fullerite-C32',region:'Wormhole',security:'C3-C6 W-space',units:4000,clouds:2,guarded:true,hazard:'Sleeper waves after warp-in delay'},
      {name:'Bountiful Frontier Reservoir',gas:'Fullerite-C28',region:'Wormhole',security:'C3-C6 W-space',units:20000,clouds:2,guarded:true,hazard:'Sleeper waves after warp-in delay'},
      {name:'Vast Frontier Reservoir',gas:'Fullerite-C28',region:'Wormhole',security:'C3-C6 W-space',units:4000,clouds:2,guarded:true,hazard:'Heavy Sleeper waves'},
      {name:'Vast Frontier Reservoir',gas:'Fullerite-C32',region:'Wormhole',security:'C3-C6 W-space',units:20000,clouds:2,guarded:true,hazard:'Heavy Sleeper waves'},
      {name:'Instrumental Core Reservoir',gas:'Fullerite-C320',region:'Wormhole',security:'C5-C6 / shattered',units:24000,clouds:2,guarded:true,hazard:'Heavy Sleepers • warp disruption'},
      {name:'Instrumental Core Reservoir',gas:'Fullerite-C540',region:'Wormhole',security:'C5-C6 / shattered',units:2000,clouds:2,guarded:true,hazard:'Heavy Sleepers • warp disruption'},
      {name:'Vital Core Reservoir',gas:'Fullerite-C320',region:'Wormhole',security:'C5-C6 / shattered',units:2000,clouds:2,guarded:true,hazard:'Heavy Sleeper wave'},
      {name:'Vital Core Reservoir',gas:'Fullerite-C540',region:'Wormhole',security:'C5-C6 / shattered',units:24000,clouds:2,guarded:true,hazard:'Heavy Sleeper wave'},
    ],
  },
};
...
async function streamTrackerVoiceToResponse(res,text,cacheKey,{priority='normal',voice='core',streamingMode=2}={}){
  ...
  try{
    response=await fetch(`${TRACKER_TTS_WORKER_URL}/synthesize-stream`,{
      ...
      signal:AbortSignal.timeout(Math.max(TRACKER_TTS_TIMEOUT_MS,120_000)),
    });
  }catch(err){
